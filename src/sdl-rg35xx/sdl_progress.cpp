...
int ProgressCreate()
{
	...
	DrawString("Finalburn Alpha for RG35XX (v " VERSION ")", (uint16 *)load_screen->pixels, 10, 20, fwidth);
	DrawString("Compiled by Novan", (uint16 *)load_screen->pixels, 10, 35, fwidth);
